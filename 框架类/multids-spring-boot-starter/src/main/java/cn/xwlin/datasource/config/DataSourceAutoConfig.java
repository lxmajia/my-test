...
import cn.xwlin.datasource.aop.DataSourceAspect;
...
public class DataSourceAutoConfig {
    ...
    public DataSourceAspect multiDataSourceAspect() {
        return new DataSourceAspect(transactionalInvoker());
    }

    @Bean
    public TransactionalInvoker transactionalInvoker() {
        return new TransactionalInvoker();
    }
