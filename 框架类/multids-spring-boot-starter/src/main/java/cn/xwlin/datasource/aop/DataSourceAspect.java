package cn.xwlin.datasource.aop;

import cn.xwlin.datasource.anno.DS;
import cn.xwlin.datasource.core.DatasourceSwtich;
import cn.xwlin.datasource.core.TransactionalInvoker;
...
public class DataSourceAspect {
  ...
  public DataSourceAspect(TransactionalInvoker transactionalInvoker) {
    this.transactionalInvoker = transactionalInvoker;
  }

  @Pointcut("@annotation(cn.xwlin.datasource.anno.DS) || @within(cn.xwlin.datasource.anno.DS)")
